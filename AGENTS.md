# Self-Host Upgrade Rehearsal (`selfhost-upgrade-rehearsal`) — factory product contract

This repository is one product built by the Param Factory. It ships at
`https://selfhost-upgrade-rehearsal.sociobot.in`. Artifact class: `cli-installers`.
