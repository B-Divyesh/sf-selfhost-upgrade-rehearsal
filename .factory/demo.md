...
The sample demo is Arbor Desk upgrading from 1.8.4 to 2.0.0. It contains three test workspaces, two configuration schemas, and sample commands for backup, restore, and health checks. No real project data is present.
